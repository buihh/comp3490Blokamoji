module Tools{
    export function createRoom(){
        ...
        var floor = new THREE.Mesh(
            new THREE.BoxGeometry(3000, 10, 2000), floorMaterial
        );
        ...
        var wallLeft = new THREE.Mesh(
            new THREE.BoxGeometry(10, 2000, 2000), wallMaterial
        );
        ...
        var wallBack = new THREE.Mesh(
            new THREE.BoxGeometry(3000, 2000, 10), wallMaterial
        );
        wallBack.position.set(0, 1000, 1000);
        scene.add(wallBack);
    }

    export function fancyLighting(){
