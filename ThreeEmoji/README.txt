...
***********************************************************************/
 ...
 Windows 10 & Firefox.
 A local http server is necessary for texture loading.
 ...
 **********************************************************************/
 ...
 vi I put partially completed because I added the glow effect but for some reason
    I couldn't get the actual text to appear. The code is in Room.ts.

 vii I put partially completed because I used a Phong material to make it glossy
     but I was unable to create the reflection of the claw machine in the floor.